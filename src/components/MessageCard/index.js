...
import {ReactComponent as Replied} from '../../assests/icons/replied.svg'


function MessageCard({children, avatarSrc, avatarStatus, statusText, name, time, message, unreadCount, active, replied, ...rest }) {
